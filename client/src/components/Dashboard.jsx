...
import EditTaskFormModal from "./EditTaskForm";
import Navbar from "./Navbar";
import { BellRing, Calendar, LogOutIcon, Mail, NotebookPen, Plus, Settings, User, UserIcon } from "lucide-react";
...
export default function Dashboard() {
  ...
  const [taskLimitReached, setTaskLimitReached] = useState(false);
  const [completedTaskId, setCompletedTaskId] = useState(null);
  const [dropdownVisible, setDropdownVisible] = useState(false); // State for mobile dropdown visibility
